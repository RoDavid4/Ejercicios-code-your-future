...
//Desarrollarás un programa que solicitará al usuario el precio de un producto y determinará si tiene derecho a un descuento.
...
//De lo contrario, se mostrará el precio original sin descuento.
    public static void descuento(){
        ...
        if (precioLista >= 100) { precioLista *= 0.9;}
...
//Desarrollarás un programa que solicite al usuario su edad y determine en qué categoría se encuentra.
    ...
    public static void edades() {
        ...
        if (edad >= 0){
            if (edad < 18) {System.out.println("Eres menor de edad");}
                else if (edad <= 64) {System.out.println("Eres adulto");}
                    else {System.out.println("Eres un adulto mayor");}
        } else {System.out.println("la edad ingresada no es valida");}
